    ...
    <div className="flex justify-center items-center min-h-[80vh]">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <div className="mb-4 rounded-md border border-amber-300 bg-amber-50 p-3">
          <p className="text-sm font-medium text-amber-900">Temporary admin credentials</p>
          <input
            type="text"
            value="admin@test.com / 123"
            readOnly
            className="mt-2 w-full px-3 py-2 text-sm text-amber-900 bg-amber-100 border border-amber-300 rounded-md"
          />
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent"
              required
              disabled={loading}
            />
          </div>

...
// Source: mqtt-streaming-server/domain (interfaces: PhotoRepository,DeviceRepository,UserRepository)
//
// Generated by this command:
//
//	mockgen -package=mock_domain mqtt-streaming-server/domain PhotoRepository,DeviceRepository,UserRepository
//
...
func (m *MockPhotoRepository) GetPhotos(ctx context.Context, filters domain.PhotoFilters) ([]*domain.Photo, error) {
	m.ctrl.T.Helper()
...
func (m *MockPhotoRepository) UpdateReview(ctx context.Context, id, reviewedBy string) error {
	m.ctrl.T.Helper()
